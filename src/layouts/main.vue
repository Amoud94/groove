<template>
    <div id="main-layout">
        <div id="fixed_header" class="fixed flex flex-wrap z-20 w-full top-0 bg-white border-b md:py-1">
            <div class="flex w-full md:px-10 px-4 py-2 items-center justify-between">
                <div class="flex-1 flex items-center">
                    <span class="rounded-md  w-[8rem] h-[2rem]">
                        <img src="https://ci5.googleusercontent.com/proxy/v8t8U65fJ8Ox8wZMf2dnHaUV2Bbp4Gru5hAvkA7DUlc4pv12v0-DUOD6u20Ngu7eLFnT2NnEczev_2zUraFH_eUApAKlRswY=s0-d-e1-ft#https://assets.grooveapps.com/mail-signature/logo.png"
                            lass="w-full h-full" alt="">
                    </span>
                </div>
                <div class="flex items-center justify-end gap-4">
                    ...
                    <div class="py-0 relative gap-3 flex items-center justify-center">
                        <label class="relative cursor-pointer w-7 h-7 rounded-full bg-[#03A9F4] flex items-center justify-center shadow_border">
